...
// 本番環境DB
// $dsn = 'mysql:dbname=nichi_dev;host=127.0.0.1';
// $dbuser = 'nichi_dev';
// $dbpass = 'surp1us';

define('DB_DATABASE', 	'nichi_dev');
define('DB_USER', 			'nichi_dev');
define('DB_PASS', 			'surp1us');
define('DSN', 					'mysql:host=127.0.0.1;dbname=' . DB_DATABASE);

chdir ("/virtual/htdocs/default/push-nichitest/") ;
